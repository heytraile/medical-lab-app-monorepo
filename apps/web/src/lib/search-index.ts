...
const NAV_HITS: SearchHit[] = [
  ...
  },
  {
    ...
    kind: "nav",
    title: "Test lookup",
    subtitle: "Ordered tests by accession",
    haystack: "test lookup ordered tests accession phlebotomy collection order",
    href: "/orders",
  },
  {
    id: "nav-sync",
    kind: "nav",
    title: "Connection",
    subtitle: "Send queue to central system",
    haystack: "connection sync send pending status outbox queue",
    href: "/sync",
  },
  {
    id: "nav-release",
    ...
    haystack: "release authorize sign off pending review queue",
    href: "/release",
  },
  {
    id: "nav-patients",
